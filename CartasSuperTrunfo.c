...
int main() {
    ...
    printf("\n O PIB per capita da primeira carta é cerca de %.2f e da segunda carta é %.2f, ", PIB_per_capita, PIB_per_capita_2);
    if (PIB_per_capita == PIB_per_capita_2){
        printf("portanto temos um empate!");
    } else{
        PIB_per_capita > PIB_per_capita_2? printf ("portanto a primeira carta vence com maior PIB per capita!"): printf("portanto a segunda carta vence com maior PIB per capita!");
    }
    ...
    printf ("\nO Super Poder da primeira carta é %.2f e o Super Poder da segunda carta é %.2f, ", somatorio_1, somatorio_2);
    if (somatorio_1 == somatorio_2){
        printf("portanto temos um empate!");
    } else{
        somatorio_1 > somatorio_2? printf ("portanto a primeira carta vence!\n"): printf("portanto a segunda carta vence!\n");
    }
